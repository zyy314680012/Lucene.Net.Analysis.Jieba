...
using Lucene.Net.Analysis.Jieba.Analyser;
...
public class Viterbi : IFinalSeg
{
    ...
    private void LoadModel()
    {
        ...
        var transJson = FileExtension.ReadAllLine(ConfigManager.ProbTransFile);
        _transProbs = JsonSerializer.Deserialize<IDictionary<char, IDictionary<char, double>>>(transJson);

        var emitJson = FileExtension.ReadAllLine(ConfigManager.ProbEmitFile);
